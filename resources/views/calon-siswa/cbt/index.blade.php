                ...
                <div class="bg-white rounded-xl shadow-sm border p-6">
                    ...
                    <div
                        ...
                        <ul class="list-decimal list-inside space-y-1">
                            ...
                            <li>Gunakan tombol <span class="italic">Next</span> / <span class="italic">Previous</span>
                                untuk berpindah soal.</li>
                            <li>Pastikan menekan tombol <span class="font-medium">Selesai</span> sebelum waktu habis.
                            </li>
